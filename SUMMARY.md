...
* [➡ DID Registrar](tutorials/did-registrar/README.md)
  * [Setting up DID Registrar](tutorials/did-registrar/setting-up-did-registrar.md)
  * [Create a DID using DID Registrar](tutorials/did-registrar/create-a-did-using-did-registrar.md)
