...
* [🍈 Veramo SDK Plugin](sdk/veramo-plugin/README.md)
  ...
  * [Credential Payments](sdk/veramo-plugin/credential-payments/README.md)
    * [Understanding Access Control Conditions](sdk/veramo-plugin/credential-payments/understanding-access-control-conditions.md)
    * [Charge for Status List](sdk/veramo-plugin/credential-payments/charge-for-status-list.md)
    * [Verifier pays issuer](sdk/veramo-plugin/credential-payments/verifier-pays-issuer.md)
