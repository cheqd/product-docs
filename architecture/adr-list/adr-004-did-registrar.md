...
The [cheqd DID Registrar](https://github.com/cheqd/did-registrar) also supports the creation of [DID-Linked Resources](adr-002-did-linked-resources.md) for example, schemas, credential definitions, status lists, trust registries and logos.
