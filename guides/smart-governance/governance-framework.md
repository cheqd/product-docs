# 🧑‍⚖️ Using on-ledger Resources to support Governance Frameworks
...
A Governance Framework could be referenced using a DID URL, just as any other Resource/Collection could be referenced on cheqd.
