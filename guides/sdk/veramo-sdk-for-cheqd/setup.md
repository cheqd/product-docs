...
Now that your Veramo CLI installation is successfully set up to work with cheqd, try following our tutorials for [creating a new DID](../../../tutorials/did-operations/create-did.md) or [querying existing DIDs](../../../tutorials/did-operations/query-did.md).
