...
### 2. Clone the `did-provider-cheqd` repo
...
### 3. Generate a new local database encryption key
...
### 4. Set your DID Resolver endpoint
...
### 5. Configure your cheqd/Cosmos account keys and RPC endpoints
