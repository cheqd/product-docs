...
1. Any framework for creating keys and signing payloads, such as [Veramo CLI](../../guides/sdk/veramo-sdk-for-cheqd/setup.md);
...
This tutorial will be using the Veramo CLI for Key management. Setup the cli following this [tutorial](../../guides/sdk/veramo-sdk-for-cheqd/setup.md)
